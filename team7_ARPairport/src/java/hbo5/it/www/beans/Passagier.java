...
public class Passagier {
 ...
 private Persoon persoon;
    ...
    public Passagier(int id, int ingeschreven, int ingecheckt, int klasse_id, Vliegtuigklasse vliegtuigklasse, String plaats, int vlucht_id, Vlucht vlucht, int persoon_id, Persoon persoon) {
        this.id = id;
        this.ingeschreven = ingeschreven;
        this.ingecheckt = ingecheckt;
        this.klasse_id = klasse_id;
